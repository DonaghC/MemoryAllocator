#ifndef POOL_ALLOCATION_FREE_LIST_H
#define POOL_ALLOCATION_FREE_LIST_H

#include <cstddef>

// Singly linked list data structure with no values stored used for keeping track of free blocks of memory in memory
